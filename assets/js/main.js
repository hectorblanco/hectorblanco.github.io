...
(function() {
  $(function() {
    var activityIndicatorOff, activityIndicatorOn, captionOff, captionOn, closeButtonOff, closeButtonOn, closeNavigations, contactSection, contactSectionScene, enableContactSection, enableGallerySection, enableHomeSection, gallery, galleryMenuScene, gallerySection, gallerySectionScene, getContactHeight, getGalleryHeight, getHomeHeight, goToUrl, highlightSection, homeSection, homeSectionScene, lazySource, loadImage, menuHeightOffset, modelOff, modelOn, overlayOff, overlayOn, paintFrame, placeholder, sceneHeights, scrollController, scrollToTarget, topMenuScene, updateContactHeight, updateGalleryHeight, updateHomeHeight, updateScenes, w;
    w = $(window);
    ...
    modelOn = function() {
      var lightboxImage, lightboxModel, model, selectedImage;
    ...
    modelOff = function() {
      ...
      return lightboxModel.find("iframe").removeAttr("src");
    };
    captionOn = function() {
