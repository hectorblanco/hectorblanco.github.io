...
$(function() {
  var aboutSection, aboutSectionScene, activityIndicatorOff, activityIndicatorOn, captionOff, captionOn, closeNavigations, contactSection, contactSectionScene, enableAboutSection, enableContactSection, enableDesignerSkills, enableGallerySection, enableHomeSection, enableLanguageSkills, enableSkillBar, enableSkillsSection, enableSoftwareSkills, enableWebSkills, gallery, galleryMenuScene, gallerySection, gallerySectionScene, getAboutHeight, getContactHeight, getGalleryHeight, getHomeHeight, getSkillsHeight, goToUrl, highlightSection, homeSection, homeSectionScene, isIe, loadDesignerSkillsScene, loadLanguageSkillsScene, loadSoftwareSkillsScene, loadWebSkillsScene, menuHeightOffset, overlayOff, overlayOn, parallaxScene, parallaxTween, sceneHeights, scrollController, scrollToTarget, skillsSection, skillsSectionScene, topMenuScene, updateAboutHeight, updateContactHeight, updateGalleryHeight, updateHomeHeight, updateScenes, updateSkillsHeight, updateUrl;
  ...
  $(".img-lazy.hidden-device").each(function() {
    if ($(this).parent().is(":visible")) {
      return $(this).show().trigger("page-loaded");
    }
  });
  ...
  $("#navbar-gallery .gallery-filter a").click(function() {
    ...
    $("html,body").promise().done((function(_this) {
      return function() {
        var filter;
  ...
  updateUrl = function(targetId) {
    if (window.history && window.history.pushState) {
      return history.pushState("", document.title, targetId);
    } else {
